...
public class JogadorDAO {
    ...
    public void create(Jogador jogador) throws SQLException {
        ...
        try (PreparedStatement stmt = connection.prepareStatement(sql)) {
            ...
            stmt.setString(6, jogador.getTimeNome()); // Mudança para "time_nome"
            stmt.setInt(7, jogador.getGols()); // Gols
            stmt.executeUpdate();
        }
    }
...
public List<Jogador> read() throws SQLException {
    ...
    try (PreparedStatement stmt = connection.prepareStatement(sql);
        ...
        while (rs.next()) {
            ...
            jogador.setGols(rs.getInt("gols")); // Carregar o número de gols do jogador
    ...
    public void updateGols(int jogadorId, int gols) throws SQLException {
